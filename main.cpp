...
short switchOrdoIndex = 0;

//  indexInput untuk user memilih opsi
short indexInput;

//  Insialisasi matrix dalam bentuk array
long double matrix2x2_Pertama[2][2];
long double matrix2x2_Kedua[2][2];
long double matrix2x2_adjoin[2][2];
long double matrix3x3_Pertama[3][3];
long double matrix3x3_Kedua[3][3];
long double matrix3x3_adjoin[3][3];
    ...
    if(switchOrdoIndex == 2)
    {
        ...
        for(int i = 0;i < 2;i++) {
            for(int j = 0;j < 2;j++) {
                std::cout << "[";
                std::cout << std::fixed << std::setprecision(2) 
                          << matrix2x2_Pertama[i][j] + matrix2x2_Kedua[i][j];
                std::cout << "]";
            }
            std::cout << std::endl;
        }
        ...
        for(int i = 0;i < 3;i++) {
            for(int j = 0;j < 3;j++) {
                std::cout << "[";
                std::cout << std::fixed << std::setprecision(2) 
                          << matrix3x3_Pertama[i][j] + matrix3x3_Kedua[i][j];
                std::cout << "]";
            }
            std::cout << std::endl;
        }
...
void determinanMatrix()
{
    if(switchOrdoIndex == 2)
    {
        ...
        long double determinant = matrix2x2_Pertama[0][0]*matrix2x2_Pertama[1][1] -
                                  matrix2x2_Pertama[0][1]*matrix2x2_Pertama[1][0];
        std::cout << "Determinan matriks = ";
        std::cout << std::fixed << std::setprecision(2) << determinant;
